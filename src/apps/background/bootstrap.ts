// src/apps/background/bootstrap.ts
// 背景入口：装配与注册各模块
...
import { installConsoleProxyWithSettings } from '../../background/consoleConfig';
...
import { registerNetProxyRouter } from '../../background/netProxy';
import { registerMonthlyAlarm, handleAlarmAsync, compensateOnStartup, INSIGHTS_ALARM } from '../../background/scheduler';
