...
// WebDAV 兼容装配层，具体业务实现位于 features/webdavSync。

import { getSettings, saveSettings } from '../utils/storage';
import {
  getClientFilePath,
  normalizeWebDavBaseUrl,
} from '../features/webdavSync/domain/paths';
import type {
  WebDAVClientProfile,
  WebDAVFile,
...
import {
  ...
  sanitizeDeviceLabel,
} from '../features/webdavSync/application/clientIdentity';
import {
  listWebDAVClientProfiles,
  readWebDAVClientProfile,
  updateWebDAVClientRegistry,
} from '../features/webdavSync/application/clientRegistry';
import {
  ensureWebDAVSupportDirs,
  webDavWriteJsonFile,
} from '../features/webdavSync/infrastructure/webdavClient';
import {
  collectBackupData as collectWebDAVBackupData,
} from '../features/webdavSync/application/backupCollector';
import { listWebDAVFiles } from '../features/webdavSync/application/cleanupService';
import { performWebDAVUpload } from '../features/webdavSync/application/uploadService';
import {
  downloadBackupFileAsBase64 as downloadBackupFileAsBase64Core,
  previewBackup as previewBackupCore,
} from '../features/webdavSync/application/restorePreview';
import {
...
} from '../features/webdavSync/application/restoreService';
import {
...
} from '../features/webdavSync/application/diagnostics';
import { registerWebDAVRouterListener } from '../features/webdavSync/background/router';
...
export { sanitizeDeviceLabel } from '../features/webdavSync/application/clientIdentity';
export { isUserBackupFile, parseWebDAVResponse } from '../features/webdavSync/infrastructure/propfindParser';
export { byteSizeOf, omitLocalOnlyStorageKeys } from '../features/webdavSync/application/backupCollector';
export { buildNextWebDAVUploadIndex } from '../features/webdavSync/application/uploadIndex';
export { sanitizeImportedSettings } from '../features/webdavSync/application/importSanitizer';
export { buildBackupPreview } from '../features/webdavSync/application/restorePreview';
export { chunk, toArrayFromObjMap } from '../features/webdavSync/application/restoreService';
export { buildWebDAVDiagnosticConfig } from '../features/webdavSync/application/diagnostics';
