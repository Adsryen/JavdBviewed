...
### 首页数据图表
<div align="center">
<img src="assets/首页.png" alt="首页数据图表" width="800">
<p><em>首页 - 数据统计和可视化图表，一目了然查看观看记录</em></p>
</div>

### 番号库管理
<div align="center">
<img src="assets/番号库.png" alt="番号库管理" width="800">
<p><em>番号库 - 管理和查看已标记的视频番号</em></p>
</div>

### 演员库管理
<div align="center">
<img src="assets/演员库.png" alt="演员库管理" width="800">
<p><em>演员库 - 演员信息管理和分类功能</em></p>
</div>

### 新作品监控
<div align="center">
<img src="assets/新作品.png" alt="新作品监控" width="800">
<p><em>新作品 - 自动监控和订阅感兴趣的新发布内容</em></p>
</div>

### 115网盘任务
<div align="center">
<img src="assets/115.png" alt="115网盘任务" width="800">
<p><em>115任务 - 离线下载任务管理、搜索、刷新与状态查看</em></p>
</div>

### AI观影报告
<div align="center">
<img src="assets/报告.png" alt="AI观影报告" width="800">
...
- **Chromium**: Chrome / Edge 等（建议最新两个稳定大版）
- **Firefox**: **121+**（推荐当前稳定版或 ESR≥121）；使用独立的 `*-firefox.zip`
- **分发**: **不上架** Chrome Web Store / Firefox AMO，仅 GitHub Release 自装
...
> **📢 关于商店发布说明**
>
> 根据 Chrome Web Store 开发者计划政策第 2.7 条等规定，本扩展不适合上架官方商店。
> Firefox 侧同样**不上 AMO**。请从 GitHub Releases 下载对应浏览器的 zip 自行安装。

**下载哪个包**

| 浏览器 | 文件名 |
|--------|--------|
| Chrome / Edge | `javdb-extension-v*-chrome.zip`（兼容旧名：无 `-chrome` 后缀的 zip） |
| Firefox | `javdb-extension-v*-firefox.zip` |
...
1. 下载 `*-firefox.zip` 并解压
2. 打开 `about:debugging#/runtime/this-firefox`
3. 「临时载入附加组件」→ 选择目录中的 `manifest.json`
4. 浏览器重启后可能需重新临时载入（未商店签名时的预期行为）
...
```bash
pnpm install
pnpm run build                 # chrome + firefox zip
# 或
...
- Chromium：加载 `dist-chrome/`（或 `dist/`）
- Firefox：加载 `dist-firefox/`（manifest 已转为 `background.scripts` + gecko id / min 121）
- 发布包在 `dist-zip/`：`*-chrome.zip`、`*-firefox.zip`（另保留无后缀 legacy zip 兼容）
