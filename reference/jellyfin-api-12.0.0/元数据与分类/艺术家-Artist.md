...
| --- | --- | --- | --- |
| GET | `/Artists` | GetArtists | Gets all artists from a given item, folder, or the entire library. |
| GET | `/Artists/{name}` | GetArtistByName | Gets an artist by name. |
| GET | `/Artists/AlbumArtists` | GetAlbumArtists | Gets all album artists from a given item, folder, or the entire library. |
...
### 基本信息
**Path：** GET 服务器地址 + /Artists

**Method：** GET

**接口描述：** Gets all artists from a given item, folder, or the entire library.
...
| searchTerm | 否 | string |  | Optional. Search term. |
...
| excludeItemTypes | 否 | BaseItemKind[] |  | Optional. If specified, results will be filtered out based on item type. This allows multiple, comma delimited. |
...
| personIds | 否 | string[] |  | Optional. If specified, results will be filtered to include only those containing the specified person ids. |
...
| sortBy | 否 | ItemSortBy[] |  | Optional. Specify one or more sort orders, comma delimited. |
...
| enableTotalRecordCount | 否 | boolean | true | Total record count. |
...
| 状态码 | 描述 | Schema |
| --- | --- | --- |
| 200 | Artists returned. | BaseItemDtoQueryResult |
| 401 | Unauthorized |  |
| 403 | Forbidden |  |
...
### 基本信息
**Path：** GET 服务器地址 + /Artists/{name}

**Method：** GET

**接口描述：** Gets an artist by name.
...
| 状态码 | 描述 | Schema |
| --- | --- | --- |
| 200 | Artist returned. | BaseItemDto |
| 401 | Unauthorized |  |
| 403 | Forbidden |  |
| 503 | The server is currently starting or is temporarily not available. |  |
...
### 基本信息
**Path：** GET 服务器地址 + /Artists/AlbumArtists

**Method：** GET

**接口描述：** Gets all album artists from a given item, folder, or the entire library.
...
| 状态码 | 描述 | Schema |
| --- | --- | --- |
| 200 | Album artists returned. | BaseItemDtoQueryResult |
| 401 | Unauthorized |  |
| 403 | Forbidden |  |
| 503 | The server is currently starting or is temporarily not available. |  |
