...
| --- | --- | --- | --- |
| GET | `/Videos/{Id}/{StreamFileName}` | getVideosByIdByStreamfilename | Gets a video stream |
| HEAD | `/Videos/{Id}/{StreamFileName}` | headVideosByIdByStreamfilename | Gets a video stream |
| GET | `/Videos/{Id}/stream` | getVideosByIdStream | Gets a video stream |
| HEAD | `/Videos/{Id}/stream` | headVideosByIdStream | Gets a video stream |
| GET | `/Videos/{Id}/stream.{Container}` | getVideosByIdStreamByContainer | Gets a video stream |
| HEAD | `/Videos/{Id}/stream.{Container}` | headVideosByIdStreamByContainer | Gets a video stream |
...
### 基本信息
**Path：** GET 服务器地址 + /Videos/{Id}/{StreamFileName}
...
### 基本信息
**Path：** HEAD 服务器地址 + /Videos/{Id}/{StreamFileName}
...
### 基本信息
**Path：** GET 服务器地址 + /Videos/{Id}/stream
...
### 基本信息
**Path：** HEAD 服务器地址 + /Videos/{Id}/stream
...
### 基本信息
**Path：** GET 服务器地址 + /Videos/{Id}/stream.{Container}
...
### 基本信息
**Path：** HEAD 服务器地址 + /Videos/{Id}/stream.{Container}
