...
| --- | --- | --- | --- |
| GET | `/Albums/{Id}/InstantMix` | getAlbumsByIdInstantmix | Creates an instant playlist based on a given album |
| GET | `/Artists/InstantMix` | getArtistsInstantmix | Creates an instant playlist based on a given artist |
| GET | `/AudioBooks/NextUp` | getAudiobooksNextup | Gets a list of next up episodes |
| GET | `/Items/{Id}/InstantMix` | getItemsByIdInstantmix | Creates an instant playlist based on a given item |
| GET | `/MusicGenres/{Name}/InstantMix` | getMusicgenresByNameInstantmix | Creates an instant playlist based on a music genre |
| GET | `/MusicGenres/InstantMix` | getMusicgenresInstantmix | Creates an instant playlist based on a music genre |
| GET | `/Playlists/{Id}/InstantMix` | getPlaylistsByIdInstantmix | Creates an instant playlist based on a given playlist |
| GET | `/Songs/{Id}/InstantMix` | getSongsByIdInstantmix | Creates an instant playlist based on a given song |
...
### 基本信息
**Path：** GET 服务器地址 + /Albums/{Id}/InstantMix
...
### 基本信息
**Path：** GET 服务器地址 + /Artists/InstantMix
...
### 基本信息
**Path：** GET 服务器地址 + /AudioBooks/NextUp
...
| AlbumId | 否 | string |  | Optional. Filter by series id |
| ParentId | 否 | string |  | Specify this to localize the search to a specific item or folder. Omit to use the root |
| EnableImages | 否 | boolean|null |  | Optional, include image information in output |
| ImageTypeLimit | 否 | integer|null |  | Optional, the max number of images to return, per image type |
| EnableImageTypes | 否 | string |  | Optional. The image types to include in the output. |
...
### 基本信息
**Path：** GET 服务器地址 + /Items/{Id}/InstantMix
...
**接口描述：** Creates an instant playlist based on a music genre
...
### 基本信息
**Path：** GET 服务器地址 + /Playlists/{Id}/InstantMix
...
### 基本信息
**Path：** GET 服务器地址 + /Songs/{Id}/InstantMix
