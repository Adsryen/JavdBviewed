...
| --- | --- | --- | --- |
| GET | `/Users/{UserId}/HomeSections` | getUsersByUseridHomesections |  |
| GET | `/Users/{UserId}/Sections/{SectionId}/Items` | getUsersByUseridSectionsBySectionidItems |  |
...
### 基本信息
**Path：** GET 服务器地址 + /Users/{UserId}/HomeSections
...
| 状态码 | 描述 | Schema |
| --- | --- | --- |
| 200 | Operation successful. Returning a List<ContentSection> object. | ContentSection[] |
| 400 |  |  |
| 401 |  |  |
| 403 |  |  |
| 404 |  |  |
...
### 基本信息
**Path：** GET 服务器地址 + /Users/{UserId}/Sections/{SectionId}/Items
