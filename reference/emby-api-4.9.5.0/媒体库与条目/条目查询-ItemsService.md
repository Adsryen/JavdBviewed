...
| GET | `/Users/{UserId}/Items` | getUsersByUseridItems | Gets items based on a query. |
| GET | `/Users/{UserId}/Items/Resume` | getUsersByUseridItemsResume | Gets items based on a query. |
...
### 基本信息
**Path：** GET 服务器地址 + /Users/{UserId}/Items
...
### 基本信息
**Path：** GET 服务器地址 + /Users/{UserId}/Items/Resume
