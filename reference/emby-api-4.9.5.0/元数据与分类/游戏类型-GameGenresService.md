...
| --- | --- | --- | --- |
| GET | `/GameGenres` | getGamegenres | Gets all Game genres from a given item, folder, or the entire library |
| GET | `/GameGenres/{Name}` | getGamegenresByName | Gets a Game genre, by name |
...
### 基本信息
**Path：** GET 服务器地址 + /GameGenres

**Method：** GET

**接口描述：** Gets all Game genres from a given item, folder, or the entire library
...
### 基本信息
**Path：** GET 服务器地址 + /GameGenres/{Name}

**Method：** GET

**接口描述：** Gets a Game genre, by name
