...
| --- | --- | --- | --- |
| GET | `/Shows/{Id}/Episodes` | getShowsByIdEpisodes | Gets episodes for a tv season |
| GET | `/Shows/{Id}/Seasons` | getShowsByIdSeasons | Gets seasons for a tv series |
| GET | `/Shows/Missing` | getShowsMissing | Gets a list of missing episodes |
| GET | `/Shows/NextUp` | getShowsNextup | Gets a list of next up episodes |
| GET | `/Shows/Upcoming` | getShowsUpcoming | Gets a list of upcoming episodes |
...
### 基本信息
**Path：** GET 服务器地址 + /Shows/{Id}/Episodes
...
| 参数名称 | 是否必须 | 类型 | 示例/默认 | 备注 |
| --- | --- | --- | --- | --- |
| Season | 否 | integer|null |  | Optional filter by season number. |
...
### 基本信息
**Path：** GET 服务器地址 + /Shows/{Id}/Seasons
...
### 基本信息
**Path：** GET 服务器地址 + /Shows/Missing

**Method：** GET

**接口描述：** Gets a list of missing episodes
