...
| --- | --- | --- | --- |
| GET | `/OfficialRatings` | getOfficialratings | Gets items based on a query. |
...
### 基本信息
**Path：** GET 服务器地址 + /OfficialRatings
...
| 状态码 | 描述 | Schema |
| --- | --- | --- |
| 200 | Operation successful. Returning a QueryResult<OfficialRatingItem> object. | QueryResult_UserLibrary.OfficialRatingItem |
| 400 |  |  |
| 401 |  |  |
| 403 |  |  |
| 404 |  |  |
...
**200 字段说明（QueryResult_UserLibrary.OfficialRatingItem）**

| 名称 | 类型 | 备注 |
| --- | --- | --- |
| Items | UserLibrary.OfficialRatingItem[] |  |
