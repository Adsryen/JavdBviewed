...
| GET | `/Artists/{Name}` | getArtistsByName | Gets an artist, by name |
| GET | `/Artists/AlbumArtists` | getArtistsAlbumartists | Gets all album artists from a given item, folder, or the entire library |
