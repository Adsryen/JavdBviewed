...
| --- | --- | --- | --- |
| GET | `/Persons` | getPersons | Gets all persons from a given item, folder, or the entire library |
| GET | `/Persons/{Name}` | getPersonsByName | Gets a person, by name |
...
**接口描述：** Gets all persons from a given item, folder, or the entire library
