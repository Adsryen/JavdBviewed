...
| --- | --- | --- | --- |
| GET | `/MusicGenres` | getMusicgenres | Gets all music genres from a given item, folder, or the entire library |
| GET | `/MusicGenres/{Name}` | getMusicgenresByName | Gets a music genre, by name |
...
### 基本信息
**Path：** GET 服务器地址 + /MusicGenres

**Method：** GET

**接口描述：** Gets all music genres from a given item, folder, or the entire library
...
### 基本信息
**Path：** GET 服务器地址 + /MusicGenres/{Name}
